            ...
            <div class="card">
                    <div id="wizard1" role="application" class="wizard clearfix"><div class="steps clearfix"><ul role="tablist"></ul></div>
                        <div class="content clearfix">
                                <h3 id="wizard1-h-0" tabindex="-1" class="title current">اضافة شريك</h3>
                            <br>
                            <form action="{{ route('admin.dashboard.partners.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
