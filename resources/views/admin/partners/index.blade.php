        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0">الشركاء</h4>
                    <i class="mdi mdi-dots-horizontal text-gray"></i>
                </div>
                <a href="{{ route('admin.dashboard.partners.create') }}">
                    <br>
                            ...
                            <div class="col-sm-12">
                                <table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tr role="row"><th class="wd-15p border-bottom-0 sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="First name: activate to sort column descending" style="width: 142.24px;">Id</th>
                                        ...
                                        <th class="wd-15p border-bottom-0 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Last name: activate to sort column ascending" style="width: 142.24px;">الشعار</th>
                                    ...
                                    @foreach($partners as $partner)
                                        ...
                                        <td class="sorting_1">{{ $partner->id }}</td>
                                        <td>{{ $partner->name }}</td>
                                            <td><img class="img-fluid" src="{{ asset('img/partners/' . $partner->logo) }}" alt="Card image cap" width="80" height="70"/></td>

                                            <td>
                                            <a style="color: grey;" class="dropdown-item" href="{{ route('admin.dashboard.partners.edit', $partner->id ) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                            <form action="{{ route('admin.dashboard.partners.destroy', $partner->id) }}" method="post">
                                                @method('DELETE')
                                                @csrf
