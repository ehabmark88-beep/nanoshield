                        ...
                        <form action="{{ route('admin.dashboard.sliders.update', $slider->id ) }}" method="post" enctype="multipart/form-data">
                            ...
                            <section id="wizard1-p-0" role="tabpanel" aria-labelledby="wizard1-h-0" class="body current" aria-hidden="false">
                                <div class="control-group form-group">
                                    ...
                                    <input type="text" class="form-control required" name="name" placeholder="الاسم"  value="{{ $slider->name }}">
                                </div>
                                <div class="control-group form-group">
                                    <label class="form-label">عنوان البانر</label>
                                    <input type="text" class="form-control required" name="title" placeholder="عنوان البانر" value="{{ $slider->title }}">
                                </div>
                                <div class="control-group form-group">
                                    <label class="form-label">التفاصيل</label>
                                    <input type="text" class="form-control required" name="details" placeholder="التفاصيل" value="{{ $slider->details }}">
                                </div>
                                <div class="control-group form-group">
