				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
                        <ul class="nav">
                            <li class="">
                                <div class="nav-itemd-none d-md-flex">
                                    <a href="/home" class="d-flex  nav-item nav-link pl-0 country-flag1">
                                        <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/home.png')}}" alt="img"></span>
                                    </a>
                                </div>
                            </li>
                        </ul>
						<ul class="nav">
							<li class="">
								<div class="nav-itemd-none d-md-flex">
									<a href="{{ route('welcome') }}" class="dropdown-item d-flex">
										<div class="my-auto">
											<strong class="mr-2 ml-2 my-auto">الموقع</strong>
										</div>
									</a>
							</li>
						</ul>
