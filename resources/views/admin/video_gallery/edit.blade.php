...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <h4 class="content-title mb-0 my-auto">تعديل فيديو</h4>
    </div>
    <!-- breadcrumb -->
@endsection
...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.dashboard.video_gallery.update', $video->id) }}" method="POST">
                        @method('PATCH')
                        @csrf

                        <div class="form-group">
                            <label for="video_link">رابط الفيديو</label>
                            <input type="url" class="form-control" name="video_link" value="{{ $video->video_link }}" required>
