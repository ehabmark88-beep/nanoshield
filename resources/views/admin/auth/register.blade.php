                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.dashboard.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="admin_key" type="text" class="form-control @error('admin_key') is-invalid @enderror" name="admin_key" value="{{ old('admin_key') }}" required autocomplete="name" autofocus>
