...
<html lang="en">
	<head>
        ...
        <style>
            ...
            .main-signup-header h2, body > div.container-fluid > div > div.col-md-6.col-lg-6.col-xl-5.bg-white > div > div > div > div > div > div.main-signup-header > div > p > a  {
            ...
            .main-signup-header label, a.btn.btn-link, input#email, input#password, .bg-primary-transparent, .bg-white, .main-signup-header .form-control {
